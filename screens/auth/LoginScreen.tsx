...
import { styles } from '@/styles/loginpage/loginstyles';
            ...
            <View style={styles.button_inner}>
              ...
              >
                {buttonSpinner ? (
                  ...
                  <Text style={{ color: 'white', fontFamily: 'Sora_700Bold', fontSize: 18 }}>
                    Continue
                  </Text>
                )}
              </TouchableOpacity>
              ...
              <TouchableOpacity style={styles.buttonSecond} onPress={() => router.push("/(routes)/register")}>
                <Text>
